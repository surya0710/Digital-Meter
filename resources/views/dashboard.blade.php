                ...
                <div class="card">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            ...
                            <div class="dropdown icon-dropdown">
                                <button class="btn" id="userdropdown6" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="fa-solid fa-ellipsis"></i>
                                </button>
                    ...
                    <div class="card-body latest-activity">
                        <ul>
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-primary border-light-primary">
                                    <svg class="stroke-icon stroke-primary">
                                        <use href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#box"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-warning border-light-warning">
                                    <svg class="stroke-icon stroke-warning">
                                        <use href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#dolar"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-danger border-light-danger">
                                    <svg class="stroke-icon stroke-danger">
                                        <use href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#round-right"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-primary border-light-primary">
                                    <svg class="stroke-icon stroke-primary">
                                        <use href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#pie-chart"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-warning border-light-warning">
                                    <svg class="stroke-icon stroke-warning">
                                        <use href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#globe"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-danger border-light-danger">
                                    <svg class="stroke-icon stroke-none">
                                        <use href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#box-user"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-primary border-light-primary">
                                    <svg class="stroke-icon stroke-primary">
                                        <use href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#work-bag"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                ...
                <div class="card">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            <h3>Top Users</h3>
                            <div class="dropdown icon-dropdown">
                                <button class="btn" id="userdropdown7" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="fa-solid fa-ellipsis"></i>
                                </button>
                    ...
                    <div class="card-body top-user pt-2">
                        <ul>
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round">
                                        <img src="../assets/images/dashboard-1/user/01.png" alt="" />
                                    </div>
                                    <div>
                                        <a href="#">
                                            <h6>Alice Goodwin</h6>
                                ...
                                <button class="btn bg-light-success border-light-success text-success">Completed</button>
                                <span>$250.00</span>
                            </li>
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round">
                                        <img src="../assets/images/dashboard-1/user/02.png" alt="" />
                                    </div>
                                    <div>
                                        <a href="#">
                                            <h6>Smith Lovell</h6>
                            ...
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round">
                                        <img src="../assets/images/dashboard-1/user/03.png" alt="" />
                                    </div>
                                    <div>
                                        <a href="#">
                                            <h6>Jones Brooks</h6>
                                ...
                                <button class="btn bg-light-warning border-light-warning text-warning">Pending</button>
                                <span>$387.00</span>
                            </li>
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round">
                                        <img src="../assets/images/dashboard-1/user/04.png" alt="" />
                                    </div>
                                    <div>
                                        <a href="#">
                                            <h6>Brown Acum</h6>
                                ...
                                <button class="btn bg-light-danger border-light-danger text-danger">Canceled</button>
                                <span>$355.00</span>
                            </li>
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round">
                                        <img src="../assets/images/dashboard-1/user/05.png" alt="" />
                                    </div>
                                    <div>
                                        <a href="#">
                                            <h6>Evans Mayo</h6>
                            ...
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round">
                                        <img src="../assets/images/dashboard-1/user/06.png" alt="" />
                                    </div>
                                    <div>
                                        <a href="#">
                                            <h6>Wilson Pipes</h6>
                            ...
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round">
                                        <img src="../assets/images/dashboard-1/user/07.png" alt="" />
                                    </div>
                                    <div>
                                        <a href="#">
                                            <h6>Alice Pindar</h6>
                ...
                <div class="card height-equal">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            <h3>News & Update</h3>
                            <div class="dropdown icon-dropdown">
                                <button class="btn" id="userdropdown8" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="fa-solid fa-ellipsis"></i>
                                </button>
                    ...
                    <div class="card-body news-update">
                        <ul>
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0">
                                    <img class="img-fluid" src="../assets/images/dashboard-1/news-update/1.png" alt="" />
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0">
                                    <img class="img-fluid" src="../assets/images/dashboard-1/news-update/2.png" alt="" />
                                </div>
                                <div class="flex-grow-1">
                                    <a href="private-chat.html">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0">
                                    <img class="img-fluid" src="../assets/images/dashboard-1/news-update/3.png" alt="" />
                                </div>
                                <div class="flex-grow-1">
                                    <a href="private-chat.html">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0">
                                    <img class="img-fluid" src="../assets/images/dashboard-1/news-update/4.png" alt="" />
                                </div>
                                <div class="flex-grow-1">
                                    <a href="private-chat.html">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0">
                                    <img class="img-fluid" src="../assets/images/dashboard-1/news-update/5.png" alt="" />
                                </div>
                                <div class="flex-grow-1">
                                    <a href="private-chat.html">
                                        <h6>Business project research</h6>
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0">
                                    <img class="img-fluid" src="../assets/images/dashboard-1/news-update/6.png" alt="" />
                                </div>
                                <div class="flex-grow-1">
                                    <a href="private-chat.html">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0">
                                    <img class="img-fluid" src="../assets/images/dashboard-1/news-update/7.png" alt="" />
                                </div>
                                <div class="flex-grow-1">
                                    <a href="private-chat.html">
                                        <h6>Added new work</h6>
                ...
                <div class="card height-equal">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            <h3>Total Invest</h3>
                            <div class="dropdown icon-dropdown">
                                <button class="btn" id="userdropdown1" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="fa-solid fa-ellipsis"></i>
                                </button>
